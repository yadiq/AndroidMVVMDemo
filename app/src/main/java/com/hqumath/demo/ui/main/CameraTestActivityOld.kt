...
import com.hqumath.demo.databinding.ActivityCameraTestOldBinding
...
class CameraTestActivityOld : BaseActivity() {
    private lateinit var binding: ActivityCameraTestOldBinding
    private lateinit var viewModel: CameraTestViewModelOld
    ...
    override fun initContentView(savedInstanceState: Bundle?): View {
        ...
        binding = ActivityCameraTestOldBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    override fun initData() {
        viewModel = ViewModelProvider(this)[CameraTestViewModelOld::class.java]
